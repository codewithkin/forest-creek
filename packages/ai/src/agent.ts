...
- You cannot take a booking or a payment. When a guest is ready, send them to the booking page at ${bookingPageUrl}. The only other address you may give is the policy page, ${policyPageUrl}.
